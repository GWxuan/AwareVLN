...
_MM_ARCHITECTURE_MARKERS = ("llava", "awarevln", "onetwovla", "navid")
...
def is_mm_model(model_path):
    ...
    for architecture in architectures:
        ...
        if any(marker in name for marker in _MM_ARCHITECTURE_MARKERS):
            return True
    model_type = getattr(config, "model_type", "") or ""
    return any(marker in model_type.lower() for marker in _MM_ARCHITECTURE_MARKERS)
